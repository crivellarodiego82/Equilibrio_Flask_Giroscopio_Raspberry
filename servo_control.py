...
address = 0x68  # Questo valore indirizzo letto tramite il comando i2cdetect
bus = smbus.SMBus(1)  # settare bus = smbus.SMBus(1) per rpi 2 o bus = smbus.SMBus(0) per rpi B
...
sensor.read_raw_data()	# Legge i dati correnti dal sensore
